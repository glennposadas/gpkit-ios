#
#  Be sure to run `pod spec lint GPKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Glenn Posadas" => "admin@glennvon.com" }
  ...
  s.source       = { :git => "https://github.com/glennposadas/gpkit-ios.git", :branch => 'Swift-4.0', :tag => '0.1.5' }
